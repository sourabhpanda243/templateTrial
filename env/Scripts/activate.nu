...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Sourabh.Panda\OneDrive - Worley\Documents\python sql\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Sourabh.Panda\OneDrive - Worley\Documents\python sql\env\Scripts\deactivate.nu'
